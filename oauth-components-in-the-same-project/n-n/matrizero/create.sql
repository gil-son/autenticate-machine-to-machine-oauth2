...
create table tb_city (id int8 generated by default as identity, name varchar(255), primary key (id));
create table tb_event (id int8 generated by default as identity, date date, name varchar(255), url varchar(255), city_id int8, primary key (id));
...
create table tb_user (id int8 generated by default as identity, email varchar(255), password varchar(255), primary key (id));
...
alter table if exists tb_event add constraint FKq5kd20axqtsxpimpoxxnrvmdy foreign key (city_id) references tb_city;
